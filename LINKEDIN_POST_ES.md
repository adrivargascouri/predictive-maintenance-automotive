...
- Explicabilidad con SHAP para justificar decisiones del modelo
...
Stack:
Python, scikit-learn, XGBoost, TensorFlow/Keras, SHAP, Jupyter, Streamlit

Repositorio:
https://github.com/adrivargascouri/predictive-maintenance-automotive

Feedback bienvenido. Si trabajas en ML aplicado a industria/manufactura, me encantaria conectar.

#MachineLearning #DataScience #PredictiveMaintenance #MLOps #Python #Manufacturing
